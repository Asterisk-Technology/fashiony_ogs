...
?>
<input type="hidden" name="cust_status" value="0">
...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $cust_timestamp = time();
        $cust_status = isset($_POST['cust_status']) ? $_POST['cust_status'] : 0; // Use user-provided value, default to 0 if not provided
