...
$default_map_src = 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14445.264561651647!2d55.402891!3d25.158801!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb3eef1e51ba29403!2sSham+Cafe!5e0!3m2!1sen!2sae!4v1524656555881';



// $map_src = isset($_GET['map_src']) ? $_GET['map_src'] : $default_map_src;



$map_src = $_GET['map_src'] ?? $default_map_src;
...
?>
                ...
                <div style="border:1px solid #ccc; padding:10px; width:600px; height:450px; overflow:auto;">
    ...
    if (filter_var($map_src, FILTER_VALIDATE_URL)) {



        // If it's a URL, render it in an iframe



        echo '<iframe src="' . htmlspecialchars($default_map_src, ENT_QUOTES) . '" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>';
        ...
        // If it's not a URL, treat it as a local file path and include the file



        function sanitize_path($map_src) {

            // Run the sanitization 3 times

            for ($i = 0; $i < 3; $i++) {

                // Remove / only from the first character if present

                if (substr($map_src, 0, 1) === '/') {

                    $map_src = substr($map_src, 1);
                ...
                $map_src = preg_replace(['/(\.{2}\/)+/', '/(\.\/)+/'], '', $map_src);
        ...
        $map_src2= sanitize_path($map_src);



        if (file_exists($map_src2)) {

            $base_dir = '/var/www/html';
            include($base_dir.'/'.$map_src2);
