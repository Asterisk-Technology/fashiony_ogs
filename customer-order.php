...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            <?php
            $adjacents = 5;
            $customer_id = isset($_GET['customer_id']) ? $_GET['customer_id'] : $_SESSION['customer']['cust_id'];

            // Fetch all payments for the specified customer_id
            ...
            // Fetch paginated payments for the specified customer_id
